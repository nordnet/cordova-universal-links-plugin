...
public class ULDomain {
    ...
    public ULDomain(final String name) {
        this(name, DEFAULT_SCHEME, DEFAULT_EVENT);
    }

    public ULDomain(final String name, final String scheme) {
        this(name, scheme, DEFAULT_EVENT);
    }

    public ULDomain(final String name, final String scheme, final String event) {
        this.name = name;
